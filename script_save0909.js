...
function click_nav(element_slide){
  ...
  function volume_block (event) {
	...
	var center_height_image = Number(getComputedStyle(document.getElementById('image-group')).height.match(/[0-9]+/ig)[0])/2;
	var center_width_image = Number(getComputedStyle(document.getElementById('image-group')).width.match(/[0-9]+/ig)[0])/2;
	...
	if (this.getElementsByClassName('02')[0]) {
		this.getElementsByClassName('02')[0].setAttribute('style','transform: translateX('+translat_X_02+'px) translateY('+translat_Y_02+'px) translateZ(0px);');
	}
	...
	if (this.getElementsByClassName('03')[0]) {
		this.getElementsByClassName('03')[0].setAttribute('style','transform: translateX('+translat_X_03+'px) translateY('+translat_Y_03+'px) translateZ(0px);');
	}
	...
	if (this.getElementsByClassName('04')[0]) {
		this.getElementsByClassName('04')[0].setAttribute('style','transform: translateX('+translat_X_04+'px) translateY('+translat_Y_04+'px) translateZ(0px);');
	}
